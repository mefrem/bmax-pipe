...
export function LightModeForm({ action }: LightModeFormProps) {
  ...
  return (
    <div className="peer rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg group-hover:opacity-30">
